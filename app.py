...
def main():
    ...
    if st.button('Predict price'):
        # Perform prediction
        # Pass a DataFrame with the same feature name used during training to avoid
        # the sklearn "valid feature names" warning.
        prediction = model.predict(pd.DataFrame({'size_sqft': [size]}))
